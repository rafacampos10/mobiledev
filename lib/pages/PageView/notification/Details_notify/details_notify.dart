...
class DetailsNotify extends StatefulWidget {

  const DetailsNotify({Key? key}) : super(key: key);

  @override
  State<DetailsNotify> createState() => _DetailsNotifyState();
}

class _DetailsNotifyState extends State<DetailsNotify> {
    ...
    return Scaffold(
      ...
      body:  SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
          children: [
            Text("Aviso 1",textAlign: TextAlign.center,style: TextStyle(fontSize: 25,color: Colors.blue.shade900),),
            Text("o aviso 1 está próximo",textAlign: TextAlign.center,style: TextStyle(fontSize: 15,color: Colors.blue),),
            Container(
